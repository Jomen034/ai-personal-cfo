...
async function TransactionRows({ householdId, members }: { householdId: string; members: { id: string; display_name: string }[] }) {
  ...
  return <TransactionList transactions={(transactions || []) as unknown as React.ComponentProps<typeof TransactionList>["transactions"]} members={members} />;
}
